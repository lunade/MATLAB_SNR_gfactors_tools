...
function dcm2niix_wrapper_l(dicom_folder, nifti_folder, nifti_filename)
%
...
% unix(['dcm2niix -o', nifti_folder, ' -f ', nifti_filename,' ', dicom_folder]);

% ['dcm2niix -w 1 -o ', nifti_folder, ' -f ',nifti_filename, ' ', dicom_folder]



 unix(['/autofs/space/tmsbox_002/users/lucia/matlab_tools/MRICron/mricron_lx/dcm2nii -g, ',nifti_filename,' 1 -o ', nifti_folder, ' -f ',dicom_folder]);
