...
%
% FLAG__BIASED_SNR = 1 corrects numerator *and* denominator [[DEFAULT]],
...
% $Id: mrir_array_combine_noise_correction.m,v 1.3 2009/11/30 22:48:42 jonp Exp $
%**************************************************************************%
  ...
  if ( FLAG__CALCULATE || isempty(snr_meas) ),
    %meas/meas true/true meas/true  meas/true  meas/true
    [snr_meas, snr_true, std_ratio, avg_ratio, snr_bias] = mrir_array_combine_noise_correction_calculate(snr_true, Ncha);
  end;
  ...
  %************************************************************************%
  %%% $Source: /space/padkeemao/1/users/jonp/cvsjrp/PROJECTS/IMAGE_RECON/mrir_toolbox/mrir_array_combine_noise_correction.m,v $
  %%% Local Variables:
  %%% mode: Matlab
  %%% fill-column: 76
  %%% comment-column: 0
