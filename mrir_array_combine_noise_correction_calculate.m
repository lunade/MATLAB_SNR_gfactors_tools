function [Ameas_per_Smeas, Atrue_per_Strue, Smeas_per_Strue, Ameas_per_Atrue, Ameas_per_Strue] ...
    = mrir_array_combine_noise_correction_calculate(snr_true, Ncha, varargin)
%MRIR_ARRAY_COMBINE_NOISE_CORRECTION_CALCULATE
%
% [snr_meas, snr_true] = mrir_array_combine_noise_correction_calculate(snr_true, Ncha)
%
%
% example:
%
%   mrir_array_combine_noise_correction_calculate(0, 1);
...
% $Id: mrir_array_combine_noise_correction_calculate.m,v 1.1 2009/11/30 22:39:28 jonp Exp $
%**************************************************************************%
  ...
  %************************************************************************%
  %%% $Source: /space/padkeemao/1/users/jonp/cvsjrp/PROJECTS/IMAGE_RECON/mrir_toolbox/mrir_array_combine_noise_correction_calculate.m,v $
  %%% Local Variables:
  %%% mode: Matlab
  %%% fill-column: 76
  %%% comment-column: 0
