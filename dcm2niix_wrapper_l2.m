...
function dcm2niix_wrapper_l2(dicom_folder, nifti_folder, nifti_filename)
%
...
% ['dcm2niix -w 1 -o ', nifti_folder, ' -f ',nifti_filename, ' ', dicom_folder]
 ...
 unix(['/usr/pubsw/packages/mricrogl/new/dcm2niix -o ',nifti_folder,' -f ',nifti_filename,' ', dicom_folder]);
